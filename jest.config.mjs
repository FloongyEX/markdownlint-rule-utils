...
const config = {
   ...
   * cacheDirectory: "C:\\Users\\FloongyEX\\AppData\\Local\\Temp\\jest",
   */
   ...
   * that run some code to configure or set up the testing framework before each test
   * setupFilesAfterEnv: [],
   */

  /*
   * The number of seconds after
   * which a test is considered as slow and reported as such in the results.
   * slowTestThreshold: 5,
   */
